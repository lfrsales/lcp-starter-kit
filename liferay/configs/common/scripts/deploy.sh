...
modules=(
	...
	"https://github.com/lfrsales/article-service-template-context-contributor/releases/download/v0.0.3/com.liferay.demo.asset.article.service.template.context.contributor-1.0.0.jar"
	...
	"https://github.com/lfrsales/demo-fragment-collections/releases/download/v0.0.5/billboard.theme.contributor-1.0.0.jar"
	"https://github.com/lfrsales/demo-fragment-collections/releases/download/v0.0.5/com.liferay.fragment.collection.contributor.billboard-1.0.0.jar"
	"https://github.com/lfrsales/demo-fragment-collections/releases/download/v0.0.5/com.liferay.fragment.collection.contributor.formed.components-1.0.0.jar"
	"https://github.com/lfrsales/demo-fragment-collections/releases/download/v0.0.5/com.liferay.fragment.collection.contributor.formed.content.display-1.0.0.jar"
	"https://github.com/lfrsales/demo-fragment-collections/releases/download/v0.0.5/com.liferay.fragment.collection.contributor.header.components-1.0.0.jar"
	"https://github.com/lfrsales/demo-fragment-collections/releases/download/v0.0.5/com.liferay.fragment.collection.contributor.integrations-1.0.0.jar"
	"https://github.com/lfrsales/demo-fragment-collections/releases/download/v0.0.5/com.liferay.fragment.collection.contributor.utilities-1.0.0.jar"
	"https://github.com/lfrsales/demo-fragment-collections/releases/download/v0.0.5/d3.theme.contributor-1.0.0.jar"
	"https://github.com/lfrsales/site-se-site-initializer/releases/download/v0.0.2/com.liferay.site.se.site.initializer-1.0.0.jar"
